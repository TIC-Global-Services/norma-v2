import { BufferAttribute, InstancedBufferGeometry, StaticDrawUsage } from "three/webgpu";
...
export class GrassBladeGeometry extends InstancedBufferGeometry {
  constructor({ nSegments, bladeHeight, bladeWidth = 1 }: GrassBladeGeometryParams) {
    super();
